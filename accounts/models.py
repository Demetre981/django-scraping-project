...
class MyUser(AbstractBaseUser):
    ...
    city = models.ForeignKey("api.City", on_delete=models.SET_NULL, null=True, blank=True)
    programming_language = models.ForeignKey("api.ProgLanguage", on_delete=models.SET_NULL, null=True, blank=True)
